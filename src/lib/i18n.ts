...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "dash.coach": { ko: "AI 코치", en: "AI Coach", zh: "AI 教练" },
  "dash.coachHint": { ko: "혼란도가 높아지면 AI가 자동으로 제안합니다.", en: "AI will suggest automatically when confusion rises.", zh: "困惑度升高时AI会自动建议。" },
